...
def _task_contract_for_prompt(prompt: str) -> str:
    ...
    if task_name == "liepin.search_resumes":
        return (
            ...
            "are clearly mismatched against requirement_sheet. After search results render and native filters are "
            "applied, call seektalent_opencli_extract_visible_liepin_cards to read visible Liepin cards before opening "
            "detail pages. Use requirement_sheet to decide which visible cards are clear mismatches and which should be "
            "opened. Return seektalent.pi_liepin_resumes.v2. "
            ...
            "seektalent_opencli_apply_liepin_filters, seektalent_opencli_extract_visible_liepin_cards, "
