...
def finalize_controller_stage(
    *,
    ...
    _record_controller_success(
        ...
        build_llm_call_snapshot=build_llm_call_snapshot,
        ...
        event_artifact_paths=controller_stage_state["artifacts"],
    )
...
def record_controller_call_evidence(
    *,
    ...
    _record_controller_success(
        ...
        emit_progress=emit_progress,
        output_artifact_refs=[],
        event_artifact_paths=controller_stage_state["artifacts"][:2],
    )


def _record_controller_success(
    *,
    settings: AppSettings,
    controller: object,
    controller_decision: ControllerDecision,
    ...
    emit_llm_event(
        ...
        artifact_paths=event_artifact_paths,
        latency_ms=controller_stage_state["controller_latency_ms"],
    )
    emit_progress(
        progress_callback,
