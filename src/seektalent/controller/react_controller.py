...
def render_controller_prompt(context: ControllerContext) -> str:
    ...
    stop_guidance_text = (
        ...
        f"- Recommendation count: {context.stop_guidance.recommendation_count}\n"
        f"- Strong recommendation count: {context.stop_guidance.strong_recommendation_count}\n"
        f"- High-risk recommendation count: {context.stop_guidance.high_risk_recommendation_count}\n"
