...
- Create: `src/seektalent/providers/liepin/detail_open_claims.py` — synchronized lifecycle facade over a run-owned claim map.
...
- [ ] **Step 3: Add the persisted claim model**
...
- [ ] **Step 4: Implement the synchronized ledger**
...
- [ ] **Step 5: Run lifecycle and persistence tests**
...
- [ ] **Step 6: Commit claim lifecycle support**
...
- [ ] **Step 3: Implement safe hash derivation**
...
- [ ] **Step 4: Carry the hash through detail mapping**
...
- [ ] **Step 5: Run identity regression tests**
...
- [ ] **Step 6: Commit stable identity mapping**
...
- [ ] **Step 2: Run injection tests and verify they fail**
...
- [ ] **Step 3: Build one ledger per runtime run**
...
- [ ] **Step 4: Expose the narrow OpenCLI method**
...
- [ ] **Step 5: Run injection and composition tests**
...
- [ ] **Step 6: Commit OpenCLI ledger injection**
...
- [ ] **Step 3: Introduce a private detail-candidate value**
...
- [ ] **Step 4: Claim before calling `open_detail`**
...
- [ ] **Step 5: Add safe counters and public sanitization test**
...
- [ ] **Step 6: Run workflow and privacy tests**
...
- [ ] **Step 1: Add the cross-round end-to-end test**
...
- [ ] **Step 4: Commit end-to-end proof**
