...
| Phase 2.2: Benchmark Expansion and Attribution | Next | 扩到 15-20 条混合 JD，降低对 6 条 Agent JD 的过拟合风险。 |
...
当前下一步建议：进入 Phase 2.2 benchmark expansion，先扩到 15-20 条混合 JD 并补齐 attribution 指标。不要先做 schema slimming、reasoning model A/B，也不要在没有新证据时扩大 stop quality gate。
