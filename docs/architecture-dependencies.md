...
| `src/seektalent_ui/` | Local Workbench BFF/API, local actor ownership, persistence, source-connection routes, packaged Workbench static serving | Liepin worker internals, provider adapters, runtime control internals, or remote user identity |
