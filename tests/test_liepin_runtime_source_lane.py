            ...
            for index in range(request.page_size):
                ...
                snapshots.append(
                    ProviderSnapshot(
                        ...
                        identity_confidence="provider_subject_id",
                        extraction_source="test",
                        extractor_version="liepin-detail-test-v1",
                        pii_classification="no_direct_contact",
    ...
    class PiMappedWorker(FakeWorker):
        async def search(
            ...
            *,
            ...
            candidate = ResumeCandidate(
                resume_id="browser-fingerprint-resume",
                source_resume_id=None,
                snapshot_sha256=sha256_json(raw),
                dedup_key="browser-fingerprint-resume",
            ...
            snapshot = ProviderSnapshot(
                ...
                provider_listing_id=None,
                synthetic_candidate_fingerprint="browser-fingerprint-resume",
                identity_confidence="synthetic_fingerprint",
                extraction_source="dom_fallback",
                extractor_version="liepin-card-test-v1",
                pii_classification="no_direct_contact",
                retention_policy="provider_snapshot_30d",
                access_scope="local_run_only",
                redaction_state="redacted",
